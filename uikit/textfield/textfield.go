...
type UITextField struct {
	raw *fltk_bridge.Input
	v   view.UIView
}

// NewUITextField 创建一个新的普通输入框
func NewUITextField(x, y, width, height int, placeholder string) *UITextField {
	input := fltk_bridge.NewInput(x, y, width, height)
	if placeholder != "" {
...
func (tf *UITextField) View() *view.UIView {
	return &tf.v
}

// Raw 返回底层的 FLTK 组件
func (tf *UITextField) Raw() fltk_bridge.Widget {
	return tf.raw
}

// Text 获取输入框内容
func (tf *UITextField) Text() string {
	if tf.raw != nil {
		return tf.raw.Value()
	}
	return ""
...
// SetText 设置输入框内容
func (tf *UITextField) SetText(text string) {
	if tf.raw != nil {
...
// Placeholder 获取占位符文本
func (tf *UITextField) Placeholder() string {
	if tf.raw != nil {
		return tf.raw.Label()
	}
	return ""
...
func (tf *UITextField) SetPlaceholder(placeholder string) {
	if tf.raw != nil {
...
// SetFontSize 设置字体大小
func (tf *UITextField) SetFontSize(size int) {
	if tf.raw != nil {
...
// SetFont 设置字体
func (tf *UITextField) SetFont(font fltk_bridge.Font) {
	if tf.raw != nil {
...
// SetTextColor 设置文本颜色
func (tf *UITextField) SetTextColor(color uint) {
	if tf.raw != nil {
...
func (tf *UITextField) SetBackgroundColor(color uint) {
	if tf.raw != nil {
...
// SetEnabled 设置是否可用
func (tf *UITextField) SetEnabled(enabled bool) {
	if tf.raw != nil {
		if enabled {
			tf.raw.Activate()
		} else {
...
// IsEnabled 获取是否可用
func (tf *UITextField) IsEnabled() bool {
	if tf.raw != nil {
...
func (tf *UITextField) OnChange(callback func()) {
	if tf.raw != nil {
...
func (tf *UITextField) SetCornerRadius() {
	if tf.raw != nil {
...
func (tf *UITextField) SetBorderStyle(box fltk_bridge.BoxType) {
	if tf.raw != nil {
		tf.raw.SetBox(box)
	}
}
